...
public interface OrderService {
    ...
    OrderLog createUnlockPublish(Long uid, Long publishId) throws PublishNotFoundException, BalanceNotEnoughException;

    OrderLog createUnlockWeChatID(Long uid, Long herUid) throws BalanceNotEnoughException;
}
